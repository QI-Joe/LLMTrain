...
parser.add_argument("--model", type=str, default="iamm")
...
parser.add_argument("--word_topk", type=int, default=5)
parser.add_argument("--cs_topk", type=int, default=5)
parser.add_argument("--hgnn_hidden", type=int, default=150)
parser.add_argument("--hgnn_out", type=int, default=50)
parser.add_argument("--ctx_topk", type=int, default=5)
parser.add_argument("--con_topk", type=int, default=5)
...
parser.add_argument("--enc_type", type=str, default="")

parser.add_argument("--test_model_name", type=str, default="iamm")

# Device_id
parser.add_argument('--device_id', dest='device_id', type=str, default="0", help='gpu device id')
# Summary file name
parser.add_argument('--result_name', dest='result_name', type=str, default="my_result.txt", help='summary file name')
...
if 'ipykernel_launcher' in sys.argv[0] or any('jupyter' in arg for arg in sys.argv):
...
topk = args.topk
word_topk = args.word_topk
cs_topk = args.cs_topk
hgnn_hidden = args.hgnn_hidden
hgnn_out = args.hgnn_out
ctx_topk = args.ctx_topk
con_topk = args.con_topk
l1 = args.l1
oracle = args.oracle
