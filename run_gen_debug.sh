...
# Task 1: Qwen3-4B FSL4 Test (GPU 0)
# start Qwen4b_FSL4_test_${TIMESTAMP} \
# env CUDA_VISIBLE_DEVICES=0 python3 ZGeneration/predict_gen.py \
#     --model_name "Qwen3-4B-Instruct-2507" \
#     --cuda_device 0 \
#     --topic_name "Qwen3_FSL4_test" \
...
#     --val_ratio 0.1 \
#     --test_ratio 0.5 \
#     --checkpoint_dir outputs/Qwen3Gen_03-02/method_FSL_bs_2_inputdata_input_text_Qwen4B_FSL16/checkpoints/checkpoint-epoch-2 \
    # --raw_model \

# Task 2: Llama3.1-8B Raw Model Test (GPU 1)
start Llama31_SSL01_test_${TIMESTAMP} \
env CUDA_VISIBLE_DEVICES=1 python3 ZGeneration/predict_gen.py \
    --model_name "llama3.1-8B-Instruct" \
    --cuda_device 1 \
    --topic_name "llama31_SSL01_test" \
    --experiment_name "Multi_Run_${TIMESTAMP}" \
    --few_shot \
    --shots_per_class 4 \
    --batch_size 2 \
    ...
    --val_ratio 0.1 \
    --test_ratio 0.5 \
    --checkpoint_dir outputs/llama3.1Gen_03-08/method_SSP_bs_2_inputdata_input_text_Llama31_SSL01/checkpoints/checkpoint-epoch-2 \
...
echo "$(ts) All jobs done. Check logs/Qwen4b_rawModel_test_*.out and logs/Llama31_SSL01_test_*.out"
